  ...
  return (
    <div>
      ...
      <div
        className={
          showNavMobile
            ? " fixed w-[100%] h-full top-0 left-0 right-0 bottom-0 bg-white "
      ...
      >
        ...
        <ul className="flex flex-col md:flex-row">
          <li className="p-2 m-3 text-black-darker text-md font-normal">
          ...
          <button className="border-[1px] text-[15px] text-black-light_dark rounded-md px-[28px] py-[8px] md:m-3 font-medium border-primary_grey mt-[210px] mx-5 mb-4 ">
            <a href="#">SIGN IN</a>
          </button>
          <button className="rounded-md text-[15px] px-[28px] py-[8px] md:m-3 md:mr-0 mx-5 bg-primary_green text-white font-medium">
            <a href="#">REGISTER</a>
          </button>
        </ul>
      </div>
